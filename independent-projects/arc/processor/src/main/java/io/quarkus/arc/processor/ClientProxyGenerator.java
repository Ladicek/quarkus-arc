...
import static io.quarkus.arc.processor.Jandex2Gizmo.copyTypeParameters;
import static io.quarkus.arc.processor.Jandex2Gizmo.genericTypeOf;
import static io.quarkus.arc.processor.Jandex2Gizmo.genericTypeOfClass;
import static io.quarkus.arc.processor.Jandex2Gizmo.genericTypeOfThrows;
            ...
            MethodDesc delegateMethod = cc.method(DELEGATE_METHOD_NAME, mc -> {
                ...
                mc.body(b0 -> {
                    if (mockable) {
                        ...
                        b0.ifNotNull(cc.this_().field(mockField), b2 -> {
                            b0.return_(cc.this_().field(mockField));
                        });
                    }
