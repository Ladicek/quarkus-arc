...
public final class ContextConfigurator {
    ...
    BiFunction<BlockCreator, ParamVar, Expr> creator;
    ...
    public ContextConfigurator contextClass(Class<? extends InjectableContext> contextClazz) {
        ...
        return creator((bc, currentContextFactory) -> {
            List<Expr> args = constructor.getParameterCount() == 0 ? List.of() : List.of(currentContextFactory);
    ...
    public ContextConfigurator creator(Class<? extends ContextCreator> creatorClazz) {
        return creator((bc, currentContextFactory) -> {
            ...
            bc.withMap(params).put(Const.of(ContextCreator.KEY_CURRENT_CONTEXT_FACTORY), currentContextFactory);
    ...
    public ContextConfigurator creator(BiFunction<BlockCreator, ParamVar, Expr> creator) {
